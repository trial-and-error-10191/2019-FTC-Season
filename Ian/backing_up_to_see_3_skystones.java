          ...
          //  robot.vision.phoneServo.setPosition(robot.vision.getCenterPosition(locationDistance +
            ...
            if (robot.vision.locationFlag) {
                ...
                // on blue side
                    ...
                    // this is where ian code come in
                    sleep(500);
                    ...
                    if (!robot.vision.skyStoneFlag) {
                        ...
                        robot.createStrafeThread(24 * dir, 0.45);
                        robot.st.start();
                        while (robot.st.isAlive()) {
                            // Busy waiting
                        }
                   ...
                   // this is the third time I have moved. ( wont need this if we moved 24 inches instead of 16 inches)
