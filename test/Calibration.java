...
public class Calibration extends LinearOpMode {
    ...
    Integer cpr = 21; //counts per rotation
    ...
    Double bias = 0.69;//adjust until your robot goes 20 inches
    //
    ...
    public void runOpMode() {
        ...
        waitForStartify();
        //
        moveToPosition(39.5, .4);//Don't change this line, unless you want to calibrate with different speeds
        //
    }
    //
    /*
    ...
    public void moveToPosition(double inches, double speed) {
        ...
        if (inches < 5) {
            ...
            while (frontleft.isBusy() && frontright.isBusy() && backleft.isBusy() && backright.isBusy()) {
                telemetry.addData("motor0", frontleft.getCurrentPosition());
                telemetry.addData("motor1", frontright.getCurrentPosition());
                telemetry.addData("motor2", backleft.getCurrentPosition());
                telemetry.addData("motor3", backright.getCurrentPosition());
                telemetry.update();
            }
